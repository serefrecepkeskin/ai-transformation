...
def prompt_text(template: str) -> str:
    text = (HERE / "bootstrap-prompt.md").read_text(encoding="utf-8")
...
def main() -> int:
    ...
    if args.prompt_only:
        print(prompt_text(args.template or "<template>"))
        return 0
