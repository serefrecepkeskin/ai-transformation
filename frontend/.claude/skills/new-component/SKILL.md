...
Read `docs/engineering/conventions.md` first — it is
the source of truth. PLACEHOLDER: after the bootstrap prompt, this skill names the repo's real component location, naming style and styling system.
