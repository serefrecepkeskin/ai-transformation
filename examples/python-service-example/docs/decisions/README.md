...
| [0002](0002-fastapi-uv-sqlalchemy-stack.md)   | FastAPI + uv + SQLAlchemy yığını         | Kabul edildi |
| [0003](0003-test-taxonomy.md)                 | Dört katmanlı test taksonomisi            | Kabul edildi |
